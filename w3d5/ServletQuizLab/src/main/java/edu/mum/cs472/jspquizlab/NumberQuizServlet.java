...
public class NumberQuizServlet extends HttpServlet {
	private void generateQuizPage(Quiz sessQuiz, PrintWriter out, String currQuest, boolean error, String answer) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("btnNext") != null) {
			...
			if (q.getNumCorrect() == q.getNumQuestions() - 1) {
				...
				generateQuizPage(q, out, q.getCurrentQuestion(), !correct, answer);
			}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		generateQuizPage(q, response.getWriter(), currQuestion, false, null);
